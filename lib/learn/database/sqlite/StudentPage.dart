...
import 'package:flutter_test_app/learn/database/sqlite/db/database.dart';
import 'package:flutter_test_app/learn/database/sqlite/model/Student.dart';
                  ...
                  if (isUpdate) {
                    if (_formStateKey.currentState.validate()) {
                      ...
                      DBProvider.db
                          .updateStudent(
                              student: Student(
                                  id: studentIdForUpdate, name: _studentName))
                          .then((data) {
                        setState(() {
                          isUpdate = false;
                        });
                    ...
                    if (_formStateKey.currentState.validate()) {
                      ...
                      DBProvider.db.insertStudent(
                          student: Student(id: null, name: _studentName));
                    }
                  }
                ...
                (student) => DataRow(cells: [
                  ...
                  DataCell(
                    IconButton(
                      ...
                      onPressed: () {
                        DBProvider.db.deleteStudent(id: student.id);
                        updateStudentList();
                      },
                    ),
                  ),
