...
import 'package:flutter_test_app/learn/ux/pages/userInfoPage.dart';
          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                // GestureDetector - используется для жестов с виджетами
            ...
            DropdownButtonFormField(
              ...
              onSaved: (value) => newUser.coutry = value,
              // validator: (val) {
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text(
              '$name is now verified registered form',
              style: TextStyle(
